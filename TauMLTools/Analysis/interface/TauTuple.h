...
#define TAU_DATA() \
    ...
    TAU_VAR(Float_t, leadChargedHadronCand_time_wrt_avgtime) \
    TAU_VAR(Float_t, firstsubleadChargedHadronCand_time_wrt_avgtime) \
    TAU_VAR(Float_t, secondsubleadChargedHadronCand_time_wrt_avgtime) \
    ...
    CAND_VAR(Float_t, time_wrt_avgtime) \
